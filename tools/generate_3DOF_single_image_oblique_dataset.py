...
DATA_DIR = '/data'
DATASET_DIR = DATA_DIR + '/20210709_3DOF_Test/'
CONFIG = './cfg/tools/generate_single_image_3DOF_dataset.yaml'
VISUALISE_3D = False
...
class GenerateBalancedObliqueDataset:
    ...
    def get_hand_pose(self, grasp_center_x, grasp_center_y, grasp_2d, grasp_3d, grasp_width):
    ...
    def save_samples(self, sample, grasps, T_obj_stp, collision_checker, grasp_metrics, stable_pose):
        ...
        # Save all images in a grid around the centre
        ...
        for cnt, aligned_grasp in enumerate(aligned_grasps):
            ...
            hand_pose = self.get_hand_pose(grasp_center_x, grasp_center_y, grasp_2d, T_grasp_camera, grasp_width)
